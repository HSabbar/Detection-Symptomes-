...
Un tokenizer sépare le texte en une liste de séquence de mot, qui correspondent à des mots, puis on transforme grâce la fonctionne `pad_sequences(X, maxlen=MAX_SEQUENCE_LENGTH)` les listes des mots en tableaux de formes Numpy avec les mêmes longueurs
